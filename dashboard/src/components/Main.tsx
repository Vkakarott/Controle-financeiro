...
export default function Main({ session }: { session: any }) {
    ...
    return (
        <div className="flex items-center justify-center h-[97%] w-[95%] bg-[var(--bruma)] rounded-[40px] border-[3px] border-[var(--border)] shadow-[0_0_15px_3px_var(--shawdon)] xl:w-[77%] transition-all duration-500">
